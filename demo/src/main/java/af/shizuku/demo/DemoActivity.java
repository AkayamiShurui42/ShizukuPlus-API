...
import af.shizuku.ShizukuSystemProperties;
import af.shizuku.demo.databinding.MainActivityBinding;
import af.shizuku.demo.service.UserService;
import af.shizuku.demo.util.ApplicationUtils;
import af.shizuku.demo.util.IIntentSenderAdaptor;
import af.shizuku.demo.util.IntentSenderUtils;
import af.shizuku.demo.util.PackageInstallerUtils;
import af.shizuku.demo.util.ShizukuSystemServerApi;
